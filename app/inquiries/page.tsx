...
import useDeleteInquiry from "@app/api/hooks/inquiry/useDeleteInquiry";
import useGetInquiry from "@app/api/hooks/inquiry/useGetInquiry";
import useUpdateInquiryStatus from "@app/api/hooks/inquiry/useUpdateInquiryStatus";
...
function InquiriesPage() {
  ...
  const { mutate: updateInquiryStatus } = useUpdateInquiryStatus();
        ...
        <table className="min-w-full text-left">
          ...
          <tbody>
            {data?.data.content.map((item) => (
              <tr key={item.inquiryId} className="hover:bg-gray-50">
                ...
                <td className="border-b px-6 py-4">{item.inquiryId}</td>
                ...
                <td className="border-b px-6 py-4">
                  <DeleteButton onDelete={() => handleDelete(item.inquiryId)} />
                </td>
              </tr>
            ))}
          </tbody>
